 ...
 * @author Beck
 */
public class LucroListView extends javax.swing.JInternalFrame {

    private JDesktopPane painel;
    private Frame parent;
    private final String tabelaSQL = "fin_lucros";

    public LucroListView(JDesktopPane painel) {
        initComponents();
        this.painel = painel;
        parent = this.parent;
        resultList(jTable1, "", "");
    ...
    private void setAddLDI() {
        ...
        painel.add(lucroView);
        lucroView.setVisible(true);
        lucroView.setPosicao();
        this.dispose();
    }
    ...
    private void setAlterar() {
        if (jTable1.getSelectedRow() != -1) {
            LucroView lucroView = new LucroView((int) jTable1.getValueAt(jTable1.getSelectedRow(), 0));
            painel.add(lucroView);
            lucroView.setVisible(true);
            lucroView.setPosicao();
            this.dispose();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Lista de Lucros");
