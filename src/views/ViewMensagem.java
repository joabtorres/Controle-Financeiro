 ...
 * @author Beck
 */
public class ViewMensagem extends javax.swing.JDialog {
     ...
     */
    public ViewMensagem(java.awt.Frame parent, boolean modal, JInternalFrame internalFrame) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMensagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewMensagem dialog = new ViewMensagem(new javax.swing.JFrame(), true, new JInternalFrame());
