 ...
 * @author Beck
 */
public class DespesaListView extends javax.swing.JInternalFrame {

    private JDesktopPane painel;
    private Frame parent;
    private final String tabelaSQL = "fin_despesas";

    public DespesaListView(JDesktopPane painel) {
        initComponents();
        this.painel = painel;
        parent = this.parent;
        resultList(jTable1, "", "");
    ...
    private void setAlterar() {
        if (jTable1.getSelectedRow() != -1) {
            DespesaView despesaView = new DespesaView((int) jTable1.getValueAt(jTable1.getSelectedRow(), 0));
            painel.add(despesaView);
            despesaView.setVisible(true);
            despesaView.setPosicao();
            this.dispose();
